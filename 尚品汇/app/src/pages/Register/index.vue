    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <input placeholder="请输入你的手机号" v-model="phone" name="phone"
          v-validate="{ required: true, regex: /^1[3456789]\d{9}$/ }" :class="{ invalid: errors.has('phone') }" />
      ...
      <div class="content">
        ...
        <button style="weight:80px; height:38px;margin-left: 5px;" @click="getCode">获取验证码</button>
...
export default {
  ...
  methods: {
    ...
    async register() {
      ...
      var { phone, code, password, password1 } = this
      if (success) {
        try {
