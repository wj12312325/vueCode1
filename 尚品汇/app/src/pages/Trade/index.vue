<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="detailArr in orderInfo.detailArrayList" :key="detailArr.skuId">
          <li>
            <img :src="detailArr.imgUrl" style="weight:100px;height:100px">
          </li>
          <li>
            <p>{{ detailArr.skuName }}</p>
            <h4>7天无理由退货</h4>
          </li>
          <li>
            <h3>￥{{ detailArr.orderPrice }}</h3>
          </li>
          <li>X{{ detailArr.skuNum }}</li>
          <li>有货</li>
        </ul>
      </div>
      <div class="bbs">
